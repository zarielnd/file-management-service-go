...
const (
	...
	StorageService_GetMetadata_FullMethodName     = "/storage.v1.StorageService/GetMetadata"
...
func (c *storageServiceClient) GetFile(ctx context.Context, in *GetFileRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[FileChunk], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type StorageService_GetFileClient = grpc.ServerStreamingClient[FileChunk]
...
func (c *storageServiceClient) DownloadArchive(ctx context.Context, in *DownloadArchiveRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[FileChunk], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &StorageService_ServiceDesc.Streams[1], StorageService_DownloadArchive_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type StorageService_DownloadArchiveClient = grpc.ServerStreamingClient[FileChunk]
...
func (UnimplementedStorageServiceServer) GetFile(*GetFileRequest, grpc.ServerStreamingServer[FileChunk]) error {
...
func (UnimplementedStorageServiceServer) DownloadArchive(*DownloadArchiveRequest, grpc.ServerStreamingServer[FileChunk]) error {
...
func _StorageService_GetFile_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(StorageServiceServer).GetFile(m, &grpc.GenericServerStream[GetFileRequest, FileChunk]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type StorageService_GetFileServer = grpc.ServerStreamingServer[FileChunk]
...
func _StorageService_DownloadArchive_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(StorageServiceServer).DownloadArchive(m, &grpc.GenericServerStream[DownloadArchiveRequest, FileChunk]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type StorageService_DownloadArchiveServer = grpc.ServerStreamingServer[FileChunk]
